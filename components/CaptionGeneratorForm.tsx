...
export const CaptionGeneratorForm: React.FC<CaptionGeneratorFormProps> = ({
  ...
  return (
    <div className="bg-white p-6 md:p-8 rounded-2xl shadow-lg border border-slate-200">
      ...
      <div className="mb-6">
        <label htmlFor="language" className="flex items-center gap-2 text-sm font-semibold text-slate-700 mb-2">
            Language
        ...
        <select
            id="language"
            disabled
            title="Upgrade to Pro to unlock multi-language support"
            className="w-full px-4 py-2 border border-slate-300 rounded-lg bg-slate-100 cursor-not-allowed focus:ring-2 focus:ring-brand-primary focus:border-brand-primary transition"
        >
